...
namespace Main.Scripts.Weapons.Projectile_Weapon
{
    public class DefaultProjectileWeapon : MonoBehaviour, IWeapon
    {
        ...
        public bool AbleToAttack => _onCoolDown == false && _onReload == false && _onShowAnimation == false;
        ...
        protected virtual void Shoot()
        {
            ...
            bullet.Setup(CalcBulletDirection(), _data.bulletSpeed, _data.damage);
        ...
        protected virtual Vector3 CalcBulletDirection()
        {
            ...
            if(Vector3.Distance(hit.point,_shootPoint.position)>0.1f)
        ...
        public virtual void Setup(WeaponData data)
        {
            ...
            _audioPlayer.clip = _data.ShotSound;
            _gunAnimation.Init();
            _bulletCount = _data.bulletCount;
            _onCoolDown = false;
            _onReload = false;
            _onShowAnimation = false;
        }
